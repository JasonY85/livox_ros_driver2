...
### 2.2 Clone Livox ROS Driver 2 source code and catkin_make:
...
Launch files of ROS are in the "~/catkin_ws/src/livox_ros_driver2/launch" directory. Different launch files have different configuration parameter values and are used in different scenarios:
